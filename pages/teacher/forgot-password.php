...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (!teacherVerifyCsrf($csrf)) {
    ...
    } elseif ($email === '' || $newPassword === '' || $confirmPassword === '') {
        ...
        if (!$checkStmt) {
            ...
            $checkStmt->execute();
            $teacher = $checkStmt->get_result()->fetch_assoc();
            $checkStmt->close();
...
<head>
    ...
    <title>Teacher Forgot Password - ExamPro</title>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .logo i { color: #4f46e5; }
        .accent { color: #4f46e5; }
        h2 { font-size: 1.75rem; color: #0f1d3a; margin-bottom: 0.3rem; }
        ...
        .btn:hover { transform: translateY(-1px); box-shadow: 0 10px 20px rgba(79, 70, 229, 0.24); }
        .alert {
            border-radius: 10px;
        ...
        .footer { text-align: center; margin-top: 1.2rem; font-size: 0.92rem; }
...
<div class="container">
    <div class="header">
        ...
        <p class="sub">Reset your teacher account password</p>
    </div>
    ...
    <form method="post" novalidate>
        ...
        <div class="form-group">
            ...
            <div class="input-wrap">
                ...
                <input type="email" id="email" name="email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>" placeholder="teacher@email.com" required>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-wrap">
                ...
                <input type="password" id="new_password" name="new_password" minlength="8" placeholder="Enter new password" required>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="input-wrap">
                <i class="fas fa-lock"></i>
                <input type="password" id="confirm_password" name="confirm_password" minlength="8" placeholder="Confirm new password" required>
            </div>
        </div>
