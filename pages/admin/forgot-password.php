...
<head>
    ...
    <title>Admin Forgot Password - ExamPro</title>
...
<div class="container">
    <div class="header">
        ...
        <p class="sub">Reset your admin account password</p>
    </div>
    ...
    <form method="post" novalidate>
        ...
        <div class="form-group">
            ...
            <div class="input-wrap">
                ...
                <input type="email" id="email" name="email" value="<?= htmlspecialchars($_POST['email'] ?? '') ?>" placeholder="admin@email.com" required>
            </div>
        </div>
        <div class="form-group">
